          ...
          <div className="prose prose-sm max-w-none text-foreground/90 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-2 leading-relaxed">
                ...
                <p>② 파트너는 견적 리드 열람을 위해 열람권을 구매하거나 구독 서비스에 가입해야 합니다.</p>
            ...
            <section>
              ...
              <div className="space-y-2 leading-relaxed">
                ...
                <p>② 유료 서비스 이용요금의 환불은 관련 법령 및 회사의 환불 정책에 따릅니다.</p>
                <p>③ 열람권은 구매 후 사용하지 않은 건에 한하여 환불이 가능하며, 이미 사용한 열람권은 환불되지 않습니다.</p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-foreground mb-3">제12조 (면책조항)</h2>
              <div className="space-y-2 leading-relaxed">
                <p>① 회사는 천재지변, 전쟁, 기간통신사업자의 서비스 중지 등 불가항력적인 사유로 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.</p>
                <p>② 회사는 이용자와 파트너 간의 시공 계약, 시공 품질, 대금 지급 등에 대해 직접적인 당사자가 아니며, 이로 인해 발생하는 분쟁에 대해 책임을 지지 않습니다. 다만, 회사는 분쟁 해결을 위해 합리적인 노력을 기울입니다.</p>
