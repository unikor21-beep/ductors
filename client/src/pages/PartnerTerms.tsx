          ...
          <div className="prose prose-sm max-w-none space-y-8 text-foreground">
            ...
            <section>
              ...
              <ol className="space-y-2 text-muted-foreground list-decimal list-inside">
                ...
                <li>포인트는 유효기간이 있으며, 기간 경과 시 자동 소멸됩니다. 무상 지급된 포인트는 현금 전환·환불이 불가합니다.</li>
                <li>토큰 충전은 신용카드, 계좌이체, 간편결제 등 전자지급결제대행(PG)사를 통해 처리되며, 결제 관련 사항은 해당 결제수단의 약관 및 정책을 따릅니다.</li>
                <li>미사용 토큰은 환불을 신청할 수 있으며, 회사는 관련 법령에 따라 환불 처리합니다. 다만 결제 수수료 등 실비가 공제될 수 있고, 이미 사용한 토큰은 환불되지 않습니다.</li>
                <li>부정한 목적으로 토큰을 충전·이용한 사실이 확인되는 경우, 회사는 환급을 보류하고 소명을 요청할 수 있습니다.</li>
              </ol>
            </section>
            ...
            <section>
              ...
              <ol className="space-y-2 text-muted-foreground list-decimal list-inside">
                ...
                <li>자격 취소 시 미사용 토큰은 관련 법령에 따라 환불 처리하며, 결제 수수료 등 실비가 공제될 수 있습니다. 무상 지급된 포인트는 소멸됩니다.</li>
              </ol>
            </section>

            <section>
              <h2 className="text-lg font-semibold mb-3">제8조의2 (파트너 탈퇴)</h2>
              <ol className="space-y-2 text-muted-foreground list-decimal list-inside">
                <li>파트너는 언제든지 마이페이지를 통해 탈퇴를 신청할 수 있습니다.</li>
                <li>진행 중인 견적 거래 또는 분쟁이 있는 경우, 해당 건이 완료된 후에 탈퇴할 수 있습니다.</li>
                <li>탈퇴 시 무상 지급된 포인트 및 쿠폰은 즉시 소멸되며 복구되지 않습니다.</li>
                <li>충전한 토큰의 잔액이 있는 경우, 탈퇴 전 환불 절차를 통해 정산하여야 하며, 정산 없이 탈퇴할 경우 잔액은 소멸될 수 있습니다.</li>
                <li>탈퇴한 파트너의 계정 정보는 복구되지 않으며, 회사는 관계법령에 따라 보존 의무가 있는 거래기록, 결제·환불 이력, 부정이용 기록 등은 해당 법령이 정한 기간 동안 분리하여 보관합니다.</li>
              </ol>
            </section>
